...
namespace HwdgApiTests
{
    ...
    public class TestHardReset
    {
        ...
        [TestMethod]
        public void CanTestHardResetWhenIdle()
        {
            Assert.AreEqual(Response.TestHardResetOk, hwdg.TestHardReset());
        ...
        [TestMethod]
        public void CanTestHardResetWhenMonitoring()
        {
            hwdg.Start();
            Assert.AreEqual(Response.TestHardResetOk, hwdg.TestHardReset());
            Assert.IsFalse(hwdg.GetStatus().State.HasFlag(WatchdogState.IsRunning));
        ...
        [TestMethod]
        public void CanTestHardResetWhenWaitingForReboot()
        {
