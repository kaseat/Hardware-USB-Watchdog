...
{
    [TestClass]
    public class SoftResetAttempts
    {
        ...
        [TestMethod]
        public void CanSetSoftResetAttemptsWhenIdle()
        {
            ...
            {
                Assert.AreEqual(Response.SetSoftResetAttemptsOk, hwdg.SetSoftResetAttempts(attempts));
        ...
        [TestMethod]
        public void CannotSetSoftResetAttemptsWhenMonitoring()
        {
            const Byte attempts = 4;

            hwdg.Start();
            Assert.AreEqual(Response.Busy, hwdg.SetSoftResetAttempts(attempts));
        ...
        [TestMethod]
        public void CannotSetSoftResetAttemptsWhenWaitingForReboot()
        {
