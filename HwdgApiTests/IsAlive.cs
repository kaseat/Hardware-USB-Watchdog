...
namespace HwdgApiTests
{
    ...
    public class IsAlive
    {
        ...
        [TestMethod]
        public void CanSendIsAliveWhenIdle()
        {
            Assert.AreEqual(Response.SoftwareVersion, hwdg.IsAlive());
            Assert.IsFalse(hwdg.GetStatus().State.HasFlag(WatchdogState.IsRunning));
        }

        [TestMethod]
        public void CanSendIsAliveWhenMonitoring()
        {
            hwdg.Start();
            Assert.AreEqual(Response.SoftwareVersion, hwdg.IsAlive());
        ...
        [TestMethod]
        public void CanSendIsAliveWhenWaitingForReboot()
        {
